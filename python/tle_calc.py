...
# Copyright Colton Riedel (2019) with heavy modification - Barry von Tobel
# License: MIT
...
#
    ...
    #    print v
        ...
        #print datestamp
        outfile.write(satnum + "," + sat + "," + datestamp + position_string + "\n");
### DEBUG
        print satnum
        print position_string
        print type(satnum)
        print type(datestamp)
        print type(position_string)
...
def main():
    ...
    eol_index = data.find("\n", name_index)
    #satnum = data.find(satellite.satnum.strip()
...
#
    if sat.strip() != "":
        ...
        #print "sat = " + sat
        #print "time =  " + str(time)
        #print "eol_index = " + str(eol_index)
        #print "us_inc = " + str(us_inc)
...
# https://github.com/coltonriedel/tle/blob/master/tle_calc.py
